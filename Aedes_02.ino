/*
  ...
  PROJET CHANGES
  ==================================
  01  -   Reassigned pin numbers, added debug routines, added external files, inverted pot values
  02  -   Inverted evnlope filter switch, replaced button functionality
...
#define DEBUG 05       // Switch debug output on or off
